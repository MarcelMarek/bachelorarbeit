...
\begin{document}
   ...
   \tableofcontents
   \newpage
   \include{einleitung/motivation}
   \include{einleitung/zielsetzung}
   \include{einleitung/aufbau}

   \newpage
   \include{grundlagen/labeling-plattformen-definition}
   \include{grundlagen/softwarestack-begriffsdefinition}
   \include{grundlagen/labeling-plattform-anforderungen}
   \include{grundlagen/labeling-platform-ueberblick-softwarestacks}

   \newpage
   \include{evaluierungskriterien/features}
   \include{evaluierungskriterien/performance}
   \include{evaluierungskriterien/usability}
   \include{evaluierungskriterien/sicherheit}
   \include{evaluierungskriterien/anpassbarkeit}
   \include{evaluierungskriterien/unterstuetzung}

   \newpage
   \include{vergleich/stack-a}

   \newpage
   \include{fallstudie/anforderungsanalyse}
   \include{fallstudie/architektur}
   \include{fallstudie/implementierung}
   \include{fallstudie/testing}
   \include{fallstudie/herausforderungen-entwicklung}

   \newpage
   \include{bewertung/bewertung}
   \include{bewertung/vergleich-anforderungen}
    \include{bewertung/erkenntnisse}
   \include{bewertung/fazit}
   ...
   \include{einleitung/definition}
   \include{einleitung/research}
